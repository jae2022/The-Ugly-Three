...
const TextRotate = forwardRef<TextRotateRef, TextRotateProps>(
  (
    ...
    return (
      <motion.span
        className={cn("flex flex-wrap whitespace-pre-wrap", classNames?.[currentTextIndex] ?? mainClassName)}
        {...props}
        animate={colors ? { backgroundColor: colors[currentTextIndex] } : undefined}
        layout
        transition={{
